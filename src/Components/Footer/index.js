...
export default function Footer() {
  ...
  return (
    <footer className="bg-footerBg h-  max-sm:h-min bg-cover bg-top object-cover py-10 max-sm:py-3 gap-5">
      ...
      <div className="mt-8 max-sm:mt-2 mb-8 lg:mx-96 xl:mx-14 flex flex-row justify-evenly font-conforter sm:font-semibold max-sm:text-xs xl:text-xs text-white flex-wrap gap-10 max-sm:gap-2 max-sm:px-6">
