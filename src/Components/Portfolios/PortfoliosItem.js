...
export default function PortfoliosItem({ item, index }) {
  ...
  return (
    <div
      ...
      key={index}
      className="bg-portfolioCart border-4 max-sm:border-2 border-[#535353] h-96 w-[26.5rem] max-sm:w-72 max-sm:h-80 rounded-2xl p-3 flex flex-col gap-2 cursor-pointer"
    >
